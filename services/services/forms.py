...
class ProductModelForm(forms.ModelForm):
    class Meta:
        model = ProductModel
        fields = ("name", "site", "speed_print", "category", "brand", "sku")
        widgets = {
            "name": forms.TextInput(attrs={"class": "form-control"}),
            "site": forms.URLInput(attrs={"class": "form-control", "placeholder": "https://example.com/product"}),
            "speed_print": forms.NumberInput(attrs={"class": "form-control", "placeholder": "стр/мин"}),
...
class ConsumableForm(forms.ModelForm):
    class Meta:
        model = Consumable
        fields = ("name", "site", "device_type", "color", "format_print", "speed_print", "category", "brand", "sku", "weight", "dimensions")
        widgets = {
            "name": forms.TextInput(attrs={"class": "form-control"}),
            "site": forms.URLInput(attrs={"class": "form-control", "placeholder": "https://example.com/product"}),
            "device_type": forms.TextInput(attrs={"class": "form-control", "placeholder": "Например, Картридж, Тонер"}),
            "color": forms.TextInput(attrs={"class": "form-control", "placeholder": "Например, черный, цветной"}),
            "format_print": forms.TextInput(attrs={"class": "form-control", "placeholder": "Например, A4"}),
            "speed_print": forms.NumberInput(attrs={"class": "form-control", "placeholder": "стр/мин"}),
            "category": forms.Select(attrs={"class": "form-select"}),
            "brand": forms.Select(attrs={"class": "form-select"}),
            "sku": forms.TextInput(attrs={"class": "form-control"}),
            "weight": forms.TextInput(attrs={"class": "form-control", "placeholder": "Например, 0.7 кг"}),
            "dimensions": forms.TextInput(attrs={"class": "form-control", "placeholder": "Например, 300×110×100 мм"}),
        }
...
class PartForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "name": forms.TextInput(attrs={"class": "form-control"}),
            "site": forms.URLInput(attrs={"class": "form-control", "placeholder": "https://example.com/product"}),
            "device_type": forms.TextInput(attrs={"class": "form-control", "placeholder": "Например, Печь, Вал, Шестерня"}),
            "color": forms.TextInput(attrs={"class": "form-control", "placeholder": "Например, черный, цветной"}),
            "format_print": forms.TextInput(attrs={"class": "form-control", "placeholder": "Например, A4"}),
            "speed_print": forms.NumberInput(attrs={"class": "form-control", "placeholder": "стр/мин"}),
            "category": forms.Select(attrs={"class": "form-select"}),
